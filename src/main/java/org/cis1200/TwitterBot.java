        ...
        if (numWords < 0) {
            ...
            while (numWords > 0) {
                if (mc.hasNext()) {
                    ...
                    if (numWords == 1) {
                        tweet.append(" ").append(word).append(randomPunctuation());
                    } else {
                        tweet.append(" ").append(word);
                    }
                    numWords--;
                } else {
                    String punctuation = randomPunctuation();
                    tweet.append(punctuation);
                    mc.reset();
                }
            }

            return tweet.substring(1); // Remove the leading space
        }
